...
* @author Губин А.А.
* @version 1.0
* @brief Описание класса PerestanCipher
* @date 05.11.2022
* @copyright ИБСТ ПГУ
*/
#pragma once
...
/// @brief Запрещающий конструктор без параметров
     ...
     *@param Экземляр класса "PerestanCipher", в котором установился ключ
     ...
     * размер таблицы в строках вычисляется по формуле, а количество столбцов - это ключ, который устанавливается в экземляре класса "PerestanCipher".</p>
     * @code
     * wchar_t a[h][w.k];
     *@endcode
